      ...
      <div class="sticky top-0 z-40 -mx-8 px-8 bg-white/80 backdrop-blur-md border-b border-slate-100 py-4">
        ...
        <div class="max-w-[1200px] mx-auto space-y-10">
          ...
          >
            ...
            >
              ...
              <AppCard id="intelligence" class="!p-10 space-y-10 border-slate-200 scroll-mt-24">
                ...
                <div v-if="!isEditingGeneral" class="space-y-12 animate-in fade-in duration-700">
                  <div class="grid md:grid-cols-2 gap-x-12 gap-y-10">
                    <div class="space-y-2">
                      <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Organization Name</p>
                      <p class="text-sm font-black text-slate-900 uppercase tracking-tight">{{ orgName }}</p>
                    </div>
                    <div class="space-y-2">
                      <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Support Email</p>
                      <p class="text-sm font-black text-slate-900 tracking-tight italic">{{ supportEmail }}</p>
                    </div>
                    <div class="md:col-span-2 space-y-2">
                      <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Mission Statement</p>
                      <p class="text-sm font-black text-slate-900 tracking-tight leading-relaxed uppercase">Empowering communities through transparent collection and efficient resource allocation.</p>
                    </div>
                  </div>
                </div>
              ...
              <AppCard id="branding" class="!p-10 space-y-10 border-slate-200 scroll-mt-24">
                ...
                <div v-if="!isEditingGeneral" class="grid md:grid-cols-2 gap-12 animate-in fade-in duration-700">
                  <div class="space-y-4">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Primary Brand Logo</p>
                    <div class="w-24 h-24 bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-300">
                      <ImageIcon class="w-8 h-8" />
                    </div>
                  </div>
                  <div class="space-y-4">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Receipt / POS Branding</p>
                    <div class="w-24 h-24 bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-300">
                      <Printer class="w-8 h-8" />
                    </div>
                  </div>
                </div>
                <div v-else class="grid md:grid-cols-2 gap-12 animate-in slide-in-from-top-2 duration-500">
                  <ModernImageInput 
              ...
              <AppCard id="health" class="!p-12 space-y-12 border-slate-200 scroll-mt-24">
                ...
                <div class="grid md:grid-cols-2 gap-12">
                  ...
                  <div class="p-12 border border-slate-100 bg-slate-50/50 flex items-start gap-8 relative overflow-hidden">
                    ...
                    <div>
                      <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.3em] mb-4">Strategic Gateway</p>
                  ...
                  <div class="p-12 border border-slate-100 bg-slate-50/50 flex flex-col justify-center">
                    <h4 class="text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 mb-10">Infrastructure Health</h4>
                    <div class="space-y-8">
                      <div class="flex items-center justify-between pb-6 border-b border-slate-200/50">
                        <div class="space-y-1">
                          ...
                          <p class="text-xs font-black text-slate-900 uppercase tracking-tight">PostgreSQL Cluster</p>
                        </div>
                        <span class="text-[10px] font-black uppercase text-emerald-500">Optimal</span>
                      </div>
                      <div class="flex items-center justify-between">
                        <div class="space-y-1">
                          <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Storage Status</p>
                          <p class="text-xs font-black text-slate-900 uppercase tracking-tight">Cloud Capacity</p>
                        </div>
          ...
          >
            ...
            >
              <AppCard id="localization" class="!p-10 space-y-10 border-slate-200 scroll-mt-24">
                <EditorialHeader 
                ...
                <div v-if="!isEditingRegional" class="grid md:grid-cols-2 gap-10 animate-in fade-in duration-700">
                  <div class="space-y-2">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Operational Currency</p>
                    <p class="text-sm font-black text-slate-900 uppercase tracking-tight">Ghana Cedi (GHS)</p>
                  </div>
                  <div class="space-y-2">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">System Locale</p>
                    <p class="text-sm font-black text-slate-900 uppercase tracking-tight italic">English (Ghana)</p>
                  </div>
                </div>
          ...
          >
            ...
            >
              <AppCard id="topology" class="!p-10 space-y-8 border-slate-200 scroll-mt-24">
                ...
                <div v-if="!isEditingInfrastructure" class="space-y-10 animate-in fade-in duration-700">
                  <div class="grid md:grid-cols-2 gap-10">
                    <div class="space-y-2">
                      <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Operational API Endpoint</p>
                      <p class="text-sm font-black text-slate-900 tracking-tight italic">https://api.mftl.com/v1</p>
                    </div>
                    <div class="space-y-2">
                      <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Secure Storefront URL</p>
                      <p class="text-sm font-black text-slate-900 tracking-tight italic">https://give.mftl.com</p>
                    </div>
                  </div>
                </div>
              ...
              <AppCard id="hubs" class="!p-12 border-slate-200 bg-slate-50/30 scroll-mt-24">
                ...
                <div v-if="branches?.length" class="mt-10 space-y-4">
                  <div 
                  ...
                  >
                    <div class="flex items-center gap-6">
                      ...
                      <div>
                        <p class="text-[13px] font-black text-slate-900 tracking-tight uppercase leading-none">{{ branch.name }}</p>
                        <div class="flex items-center gap-2 mt-2">
                          <div class="w-1.5 h-1.5 rounded-full" :class="branch.isActive ? 'bg-emerald-500' : 'bg-slate-300'" />
                ...
                <div v-else class="mt-10 py-16 flex flex-col items-center justify-center border border-dashed border-slate-200 text-center gap-4">
                  <div class="w-12 h-12 bg-white border border-slate-100 flex items-center justify-center text-slate-200">
                    <Building2 class="w-6 h-6" />
                  </div>
                  <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">No active hubs deployed</p>
                    <p class="text-[9px] font-bold text-slate-300 uppercase tracking-widest mt-2">Regional infrastructure matrix is empty</p>
                  </div>
                </div>
              </AppCard>
          ...
          >
            ...
            >
              <AppCard id="controls" class="!p-8 space-y-8 border-slate-200 bg-white scroll-mt-24">
                <EditorialHeader 
                ...
                <div v-if="!isEditingOperational" class="space-y-6 animate-in fade-in duration-700">
                  <div v-for="ctrl in [{t:'Auth0 Dev Bypass', v:'Active', s:'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]'}, {t:'Maintenance Guard', v:'Inactive', s:'bg-slate-300'}, {t:'Public Leaderboard', v:'Active', s:'bg-emerald-500'}]" :key="ctrl.t" class="flex items-center justify-between p-6 bg-slate-50 border border-slate-100 rounded-none">
                    <div>
                      <p class="text-xs font-black text-slate-900 uppercase tracking-tight">{{ ctrl.t }}</p>
                      <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">{{ ctrl.v }}</p>
                    </div>
                    <div class="w-2 h-2 rounded-none" :class="ctrl.s" />
                  </div>
                </div>

                <div v-else class="space-y-6 animate-in slide-in-from-top-2 duration-500">
              ...
              <AppCard id="audit" class="!p-10 space-y-10 border-slate-200 scroll-mt-24">
                <EditorialHeader title="Audit & Event Log" subtitle="Step 02" />
                <div class="space-y-6">
                  <div 
                    v-for="i in 3" 
                    :key="i"
                  ...
                  >
                    ...
                    <div>
                      <p class="text-[11px] font-black text-slate-900 uppercase tracking-tight">System Configuration Updated</p>
                      <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Platform Admin • 2 hours ago</p>
                    </div>
                  </div>
                </div>
              </AppCard>
